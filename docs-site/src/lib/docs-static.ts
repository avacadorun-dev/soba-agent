...
const pagesByLang: Record<SupportedLang, DocsPage[]> = {
  en: [
    ...
    { slug: "plan-mode", path: "plan-mode.en.mdx", title: "Plan and goal modes", group: "workflow" },
    { slug: "compaction", path: "compaction.en.mdx", title: "Compaction and Context Capsules", group: "workflow" },
  ...
  ru: [
    ...
    { slug: "plan-mode", path: "plan-mode.ru.mdx", title: "Plan и goal mode", group: "workflow" },
  ...
  zh: [
    ...
    { slug: "plan-mode", path: "plan-mode.zh.mdx", title: "Plan 与 goal 模式", group: "workflow" },
    { slug: "compaction", path: "compaction.zh.mdx", title: "Compaction 与 Context Capsules", group: "workflow" },
