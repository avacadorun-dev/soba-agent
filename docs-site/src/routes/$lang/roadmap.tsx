...
const copy = {
  badge: {
    en: "Roadmap · v0.4.0 focus",
    ru: "Roadmap · фокус v0.4.0",
    zh: "路线图 · v0.4.0 重点",
  },
  title: {
  ...
  horizonLead: {
    ...
    ru: "Каждый шаг сначала повышает доверие, а уже потом добавляет автономность.",
...
const stages = [
  {
    icon: ShieldCheck,
    release: "v0.4.0",
    state: { en: "Current focus", ru: "Текущий фокус", zh: "当前重点" },
    title: {
      en: "Trust foundation",
      ru: "Фундамент доверия",
      zh: "信任基础",
    },
    intent: {
      en: "Project Memory, MCP tools, and a verified agent loop become one release stream.",
      ru: "Project Memory, MCP-инструменты и проверяемый agent loop входят в один релизный поток.",
    ...
    outcomes: {
      ...
      ru: [
        "Помнит контекст проекта",
        "Подключает внешние инструменты",
        "Показывает понятный ход работы",
        "Не завершает код без evidence",
      ],
  ...
  },
  {
    ...
    title: {
      en: "Visible proof",
      ru: "Видимые доказательства",
      zh: "可见证据",
    },
    intent: {
      en: "The user should see what changed, what ran, what passed, and what still carries risk.",
      ru: "Пользователь должен видеть, что изменилось, что запускалось, что прошло и где остался риск.",
      zh: "用户应看到改了什么、运行了什么、通过了什么，以及风险在哪里。",
    },
    outcomes: {
      en: ["Evidence bundle", "Diff review", "First-run polish"],
      ru: ["Evidence bundle", "Diff review", "Полировка первого запуска"],
      zh: ["证据包", "差异审查", "首次体验打磨"],
    },
  },
  {
    ...
    title: {
      ...
      ru: "Живые знания проекта",
      zh: "活的项目知识",
    },
    intent: {
      en: "Memory becomes maintained knowledge, not a pile of notes.",
      ru: "Memory становится поддерживаемым знанием, а не кучей заметок.",
      zh: "记忆成为被维护的知识，而不是一堆笔记。",
    },
    outcomes: {
      en: ["Memory updates", "Staleness checks", "Provenance"],
      ru: ["Обновления памяти", "Проверка устаревания", "Provenance"],
      zh: ["记忆更新", "过期检查", "来源记录"],
    },
  },
  {
    ...
    outcomes: {
      ...
      ru: ["Task model", "Git worktrees", "Attach и resume"],
  ...
  },
  {
    ...
    outcomes: {
      ...
      ru: ["Verification contracts", "Smart escalation", "Укрепление релиза 1.0"],
...
const principles = [
  {
    ...
    title: {
      ...
      ru: "Проверка раньше уверенности",
      zh: "先验证，再确信",
    },
    text: {
      en: "A green answer should be backed by visible work, commands, evidence, or a clear unverified status.",
      ru: "Зелёный ответ должен опираться на видимый ход работы, команды, evidence или честный статус unverified.",
  ...
  },
  {
    ...
    title: {
      ...
      ru: "Расширяемо, но не хаотично",
      zh: "可扩展，但不混乱",
    },
    text: {
      en: "MCP and skills expand the toolset while the runtime keeps permissions and results understandable.",
      ru: "MCP и skills расширяют инструменты, а runtime сохраняет понятные разрешения и результаты.",
  ...
  },
  {
    ...
    title: {
      ...
      ru: "Долгая работа без деградации контекста",
      zh: "长任务不腐烂上下文",
    },
    text: {
      en: "Sessions, capsules, checkpoints, and memory should preserve the task state across long work.",
      ru: "Sessions, capsules, checkpoints и memory должны сохранять состояние задачи на длинной дистанции.",
