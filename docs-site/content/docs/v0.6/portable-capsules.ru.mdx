...
description: "Переносимые knowledge capsules в SOBA Agent: создание, экспорт, загрузка, безопасность и ручная проверка."
---
...
- [Compaction и Context Capsules](/ru/docs/v0.6/compaction)
- [Сессии](/ru/docs/v0.6/sessions)
