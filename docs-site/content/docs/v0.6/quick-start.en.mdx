---
title: Quick Start
description: "Start SOBA Agent v0.6.7: install, provider, TUI, plan mode, proof receipts, Project Memory, MCP, skills, and verification."
---

This guide takes you from a clean install to a working SOBA v0.6.7 workflow. It is the practical path: install, verify
