...
See [Providers and models](/en/docs/v0.6/providers) for the full provider registry.
...
Next: [CLI reference](/en/docs/v0.6/cli-reference), [Interface and commands](/en/docs/v0.6/usage),
[MCP servers](/ru/docs/v0.6/mcp), and [Skills](/ru/docs/v0.6/skills).
