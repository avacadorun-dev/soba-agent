---
title: Быстрый старт
description: "Актуальный быстрый старт SOBA v0.6.4: запуск, provider, TUI, proof receipts, Project Memory, MCP, capsules и проверки."
---

Этот гайд доводит от чистого запуска до рабочего SOBA v0.6.4 workflow. Он не заменяет справочник, а показывает
