---
title: Быстрый старт
description: "Актуальный быстрый старт SOBA v0.5.0: запуск, first-run init, provider, TUI, sessions, Project Memory, MCP, capsules и проверки."
---

Этот гайд доводит от чистого запуска до рабочего SOBA v0.5.0 workflow. Он не заменяет справочник, а показывает
