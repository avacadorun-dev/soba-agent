---
title: Быстрый старт
description: "Актуальный быстрый старт SOBA v0.6.5: запуск, provider, TUI, proof receipts, Project Memory, MCP, capsules и проверки."
---

Этот гайд доводит от чистого запуска до рабочего SOBA v0.6.5 workflow. Он не заменяет справочник, а показывает
