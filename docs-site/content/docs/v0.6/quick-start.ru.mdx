---
title: Быстрый старт
description: "Актуальный быстрый старт SOBA v0.6.7: запуск, provider, TUI, plan mode, proof receipts, Project Memory, MCP, capsules и проверки."
---

Этот гайд доводит от чистого запуска до рабочего SOBA v0.6.7 workflow. Он не заменяет справочник, а показывает
