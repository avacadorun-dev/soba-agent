...
**Ключевое изменение в v0.6.0:** Модели больше не хранятся в жёстко закодированных списках —
...
SOBA v0.6.0 поставляется с 4 встроенными провайдерами. Все они используют OpenAI-совместимый адаптер.
