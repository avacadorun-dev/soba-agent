...
**Ключевое изменение в v0.5.0:** Модели больше не хранятся в жёстко закодированных списках —
...
SOBA v0.5.0 поставляется с 4 встроенными провайдерами. Все они используют OpenAI-совместимый адаптер.
