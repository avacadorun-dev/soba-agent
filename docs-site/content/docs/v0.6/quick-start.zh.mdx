---
title: 快速开始
description: "快速启动 SOBA Agent v0.6.7：安装、provider、TUI、plan mode、proof receipts、Project Memory、MCP、skills 和验证。"
---

本指南从干净安装开始，带你完成 SOBA v0.6.7 的可用工作流：安装、检查 provider、启动 TUI、执行有边界的任务、
