...
1. [Hotkeys](#2-hotkeys)
1. [Slash commands](#3-slash-commands)
1. [Direct shell](#4-direct-shell)
1. [Task queue](#5-task-queue)
1. [Token budget](#6-token-budget)
1. [Scrolling history](#7-scrolling-history)
1. [Autocomplete](#8-autocomplete)
1. [Themes](#9-themes)
1. [Languages](#10-languages)
