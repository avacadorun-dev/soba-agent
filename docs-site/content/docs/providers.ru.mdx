...
**Ключевое изменение в v0.4.4:** Модели больше не хранятся в жёстко закодированных списках —
...
SOBA v0.4.4 поставляется с 4 встроенными провайдерами. Все они используют OpenAI-совместимый адаптер.
