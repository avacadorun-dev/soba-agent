...
1. [Файл конфигурации](#1-файл-конфигурации)
1. [Полный список параметров](#2-полный-список-параметров)
1. [Переменные окружения](#3-переменные-окружения)
1. [CLI-флаги](#4-cli-флаги)
1. [Конфигурация провайдеров](#5-конфигурация-провайдеров)
1. [Compaction конфигурация](#6-compaction-конфигурация)
1. [Приоритет и переопределение](#7-приоритет-и-переопределение)
1. [Валидация конфигурации](#8-валидация-конфигурации)
...
| `model` | `string` | `""` | Полный идентификатор модели: `deepseek/deepseek-chat`, `openrouter/anthropic/claude-sonnet-4` |
...
SOBA v0.4.0 использует систему реестра провайдеров (registry). Подробнее о провайдерах — в
