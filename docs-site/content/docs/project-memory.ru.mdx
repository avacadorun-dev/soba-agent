...
description: "Постоянная память проекта в SOBA v0.4.0: knowledge files, memory capsules, entity graph, agent tools и безопасное обновление."
---
...
В v0.4.0 Project Memory — это не slash-команда пользователя. Это слой памяти, который SOBA автоматически подключает к
