...
当你希望在修改项目之前先获得只读实施计划时，使用 `/plan on`。参见 [Plan 与 goal 模式](/zh/docs/plan-mode)。
...
详见 [Project Memory](/zh/docs/project-memory)。
...
详见 [Proof receipts](/zh/docs/proof)。
...
| 任务 | 文档 |
|---|---|
| 完整 end-to-end 项目 | [Project walkthrough](/zh/docs/walkthrough-building-a-project) |
| CLI 标志 | [CLI 参考](/zh/docs/cli-reference) |
| TUI 和 slash commands | [界面与命令](/zh/docs/usage) |
| Proof receipts | [Proof receipts](/zh/docs/proof) |
| Project Memory | [Project Memory](/zh/docs/project-memory) |
| Skills | [Skills](/zh/docs/skills) |
