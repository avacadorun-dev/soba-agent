---
title: 快速开始
description: "快速启动 SOBA Agent v0.4.1：安装、provider、TUI、session、direct shell、Project Memory、MCP 和 skills。"
---

本指南从一次干净安装开始，带你完成 SOBA v0.4.1 的最小可用工作流：检查 provider、启动 TUI、执行任务、
...
完整说明见 [Providers and models](/ru/docs/providers)。
...
下一步：[CLI reference](/ru/docs/cli-reference)、[Usage](/ru/docs/usage)、[MCP servers](/ru/docs/mcp) 和
