---
title: Quick Start
description: "Start SOBA Agent v0.4.2: install, provider, TUI, sessions, direct shell, Project Memory, MCP, and skills."
---

This guide gets you from a fresh checkout to a working SOBA v0.4.2 session. It focuses on the practical path: verify
