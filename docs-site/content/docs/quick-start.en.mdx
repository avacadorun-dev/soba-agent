...
See [Providers and models](/en/docs/providers).
...
Use `/plan on` when you want a read-only implementation plan before making changes. See [Plan and goal modes](/en/docs/plan-mode).
...
See [Project Memory](/en/docs/project-memory).
...
See [Proof receipts](/en/docs/proof).
...
| Task | Document |
|---|---|
| Full end-to-end project | [Project walkthrough](/en/docs/walkthrough-building-a-project) |
| CLI flags | [CLI reference](/en/docs/cli-reference) |
| TUI and slash commands | [Interface and commands](/en/docs/usage) |
| Proof receipts | [Proof receipts](/en/docs/proof) |
| Project Memory | [Project Memory](/en/docs/project-memory) |
| Skills | [Skills](/en/docs/skills) |
