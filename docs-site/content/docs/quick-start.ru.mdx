...
`/plan on` включает read-only режим для подготовки плана до изменения проекта. Подробнее: [Plan и goal mode](/ru/docs/plan-mode).
...
Подробнее: [Proof receipts](/ru/docs/proof).
...
| Proof receipts | [Proof receipts](/ru/docs/proof) |
