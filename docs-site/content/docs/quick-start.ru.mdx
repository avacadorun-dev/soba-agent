---
title: Быстрый старт
description: "Актуальный быстрый старт SOBA v0.4.1: запуск, provider, TUI, sessions, Project Memory, MCP, capsules и проверки."
---

Этот гайд доводит от чистого запуска до рабочего SOBA v0.4.1 workflow. Он не заменяет справочник, а показывает
