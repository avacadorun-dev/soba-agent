...
1. [Built-in providers](#2-built-in-providers)
1. [Choosing a model](#3-choosing-a-model)
1. [Custom providers](#4-custom-providers)
1. [CLI management](#5-cli-management)
1. [Authentication](#6-authentication)
1. [Diagnostics](#7-diagnostics)
...
|---|---|---|
| Fast coding | `deepseek/deepseek-chat` | V3 has a good price / quality / speed balance |
| High-quality coding | `openrouter/anthropic/claude-sonnet-4` | Strong for larger refactors |
| Chinese coding tasks | `kimi/kimi-k2` | Kimi K2 is focused on code generation |
| Reasoning | `deepseek/deepseek-reasoner` | R1 is useful for deeper reasoning |
| Free tier | `openrouter/google/gemma-3-27b-it:free` | Free models through OpenRouter |
