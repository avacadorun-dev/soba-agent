/**
 * Types for Project Memory system.
 *
 * Project Memory preserves project knowledge across sessions.
 * Three layers: Knowledge Files (always-loaded), Memory Capsules (relevance-loaded),
 * Entity Graph (queryable).
 *
 * Path: <project-root>/.soba/memory/
 */
