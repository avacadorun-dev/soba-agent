import type { EvidenceLedger, EvidenceLedgerSummary } from "../loop/evidence-ledger";
import type { TaskKind, VerificationKind } from "../loop/verification-policy";
import { verificationKindFromCommand } from "../loop/verification-policy";
