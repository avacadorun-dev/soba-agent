...
import type { OpenResponsesClient, OpenResponsesClientConfig } from "../client/openresponses-client";
import type {
  CompactResource,
...
import type { NativeCompactionInput, ProviderErrorKind } from "../middleware/types";
import type { NativeContinuation, ProviderCapabilities, ProviderIdentity } from "../session/types-v2";
