...
import type { DelegatedTerminalResult, RuntimeToolDelegation } from "../../application/tool-delegation";
...
import { type BashArgs, bashTool } from "./local/bash";
import { type InspectFileArgs, inspectFileTool } from "./local/inspect-file";
import { type LsArgs, lsTool } from "./local/ls";
import { isProjectMemoryPath, PROJECT_MEMORY_DIRECT_WRITE_NEXT_ACTION } from "./local/protected-paths";
import { type ReadArgs, readTool } from "./local/read";
import { type SearchFilesArgs, searchFilesTool } from "./local/search-files";
import { type WriteArgs, writeTool } from "./local/write";
