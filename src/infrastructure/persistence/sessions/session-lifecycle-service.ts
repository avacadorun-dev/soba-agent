...
import type { RuntimeSessionHandle, SessionLifecycleService } from "../../../application/session-lifecycle";
import type {
  CreateSessionInput,
  ListSessionsInput,
  LoadSessionInput,
...
import { sessionInfoToRuntime } from "../../../application/types";
import {
  findSessionsById,
...
export class PersistentSessionLifecycleService implements SessionLifecycleService {
  ...
  private toRuntimeInfo(session: RuntimeSessionHandle): RuntimeSessionInfo {
    return {
